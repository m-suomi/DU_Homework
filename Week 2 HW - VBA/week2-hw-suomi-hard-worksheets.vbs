'embedded ws. for any cells/ranges to cycle through each worksheet
...
start_stock_value = ws.Cells(2, 3).Value
...
end_raw_row = ws.Range("A1",ws.Range("A1").End(xlDown)).Rows.Count
...
ws.Range(ws.Cells(1, 9), ws.Cells(1, 17)).Font.Bold = True
ws.Range(ws.Cells(1, 9), ws.Cells(1, 17)).WrapText = True
ws.Cells(2,15).Value = "Greatest % Increase"
ws.Cells(3,15).Value = "Greatest % Decrease"
ws.Cells(4,15).Value = "Greatest Total Volume"
ws.Range(ws.Cells(2, 15), ws.Cells(4, 15)).Font.Bold = True
summary_row = 2
...
For i = 2 To end_raw_row
    ...
    current_row_ticker = ws.Cells(i, 1).Value
    ...
    ElseIf current_row_ticker <> next_row_ticker Then
        ...
        total_stock_volume = total_stock_volume + ws.Cells(i, 7).Value
        end_stock_value = ws.Cells(i, 6).Value
        ...
        start_stock_value = ws.Cells(i+1, 3).Value
        total_stock_volume = 0
